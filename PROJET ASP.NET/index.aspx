    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">BistroTdi</a>
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="Login page/Login.aspx" class="nav__link">Login</a></li>
                        <li class="nav__item"><a href="Register page/Regester.aspx" class="nav__link">Register</a></li>
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">BistroTdi</h1>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="Plates-01.png" alt="" class="menu__img">
                        <h3 class="menu__name">Cofee</h3>
                        <span class="menu__detail">Breakfast</span>
                        <span class="menu__preci">10.00 Dh</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="Plates-03.png" alt="" class="menu__img">
                        <h3 class="menu__name">French Breakfast</h3>
                        <span class="menu__detail">Breakfast</span>
                        <span class="menu__preci">15.00 Dh</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="Plates-02.png" alt="" class="menu__img">
                        <h3 class="menu__name">Moroccan Breakfast</h3>
                        <span class="menu__detail">Breakfast</span>
                        <span class="menu__preci">30.00 Dh</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="Plates-04.png" alt="" class="menu__img">
                        <h3 class="menu__name">Pizza</h3>
                        <span class="menu__detail">Fast food</span>
                        <span class="menu__preci">20.00 Dh</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="Plates-05.png" alt="" class="menu__img">
                        <h3 class="menu__name">Coucous</h3>
                    ...
                    <div class="menu__content">
                        <img src="Plates-06.png" alt="" class="menu__img">
                        <h3 class="menu__name">Tacos</h3>
                        <span class="menu__detail">Fast food</span>
                        <span class="menu__preci">20.00 Dh</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        <span class="section-subtitle about__initial">History</span>
                        <h2 class="section-title about__initial">About us</h2>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">BistroTdi</a>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="footer__link">Reserve your table</a></li>
                    </ul>
                </div>
                <div class="footer__content">
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li>ISTA NTIC Guelmim</li>
                        <li>Guelmim 81000</li>
                        <li>bistrotdi@email.com</li>
                    </ul>
                </div>
            </div>
            <p class="footer__copy"> &#169; 2021 <a href="https://www.linkedin.com/in/elbachir-hatem" class="footer__copy"><i class='bx bxl-linkedin'></i></a> HatemEh </p>
        </footer>
